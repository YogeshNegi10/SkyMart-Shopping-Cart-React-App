...
const Contacts = () => {
  return (
   <section className="py-8 bg-gray-100 sm:py-12 lg:py-10 mt-10">
   <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
       <div className="max-w-2xl mx-auto text-center">
           <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl">Contact us</h2>
           <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500">"Connect with us and let's make waves together!"
           ...
           <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
               <div className="overflow-hidden bg-white rounded-xl">
                   <div className="p-6">
                       ...
                       <p className="mt-6 text-md font-medium text-gray-900">+916395833359</p>
                       <p className="mt-1 text-md font-medium text-gray-900">+918057404852</p>
                   </div>
               </div>
               ...
               <div className="overflow-hidden bg-white rounded-xl">
                   <div className="p-6">
                       <svg className="flex-shrink-0 w-10 h-10 mx-auto text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                           <path stroke-linecap="round" strokeLinejoin="round" stroke-width="1" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                       </svg>
                       <p className="mt-6 text-md font-medium text-gray-900">Yogeshnegi97@gmail.com</p>
                       <p className="mt-1 text-md font-medium text-gray-900">leoYogesh13@gmail.com</p>
                   </div>
               </div>
               ...
               <div className="overflow-hidden bg-white rounded-xl">
                   <div className="p-6">
                       <svg className="flex-shrink-0 w-10 h-10 mx-auto text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                           <path stroke-linecap="round" strokeLinejoin="round" stroke-width="1" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                           <path stroke-linecap="round" strokeLinejoin="round" stroke-width="1" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                       </svg>
                       <p className="mt-6 text-md font-medium leading-relaxed text-gray-900">Village P.O maletha tehri garhwal Uttrakhand</p>
                   </div>
               </div>
           </div>
